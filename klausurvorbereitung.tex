...
\begin{itemize}
  ...
  \item Notation von Zuständen: der Zustand $s: \textbf{Var} \rightharpoonup
    \textbf{Val}$ mit $\mathcal{D}(s) = \{x_1, x_2, \dots, x_n\}$ und $s(x_i) =
  ...
  \item Die Erweiterung des Zustands $s_1: \textbf{Var} \rightharpoonup
    ...
    \begin{align*}
      ...
      & v \mapsto (s_1 \oplus s_2)(v) :=
        \begin{cases}
          s_2(v), & \Leftrightarrow v \in \mathcal{D}(s_2)\\
          s_1(v), & \Leftrightarrow v \in \mathcal{D}(s_1)
            \wedge v \notin \mathcal{D}(s_2)\\
        \end{cases}
    \end{align*}
    ...
    \rightharpoonup \textbf{Val}$ gelegentlich auch $\mathcal{Z}$.
\end{itemize}
...
\begin{itemize}
  \item Interpretationsfunktion:
    ...
    \begin{align*}
      \llbracket \ \rrbracket:
        \textbf{Exp} \rightarrow
          \left[\mathcal{Z} \rightarrow \textbf{Val} \right]
    \end{align*}
